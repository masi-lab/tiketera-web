...
var self = module.exports = {
    ...
    save_print: async function (req, res, next){
        ...
        self.print_local(etiqueta, numero_serie, ubicacion, numero_equipo,  modelo, cant);
    ...
    print: async function(req, res, next){
        self.print_local(req.data.etiqueta, req.data.numero_serie, req.data.ubicacion, req.data.numero_equipo, req.data.modelo, req.data.quantity);
    ...
    print_local: async (etiqueta, numero_serie, ubicacion, numero_equipo, modelo,  cant) => { //
        ...
        let dato = '%BTW% /AF=c:\\command\\etiqueta_qr.btw /D="%Trigger File Name%" /PRN="EasyCoder PD41 (203 dpi) - IPL" /R=3 /P /DD \n' + 
                    '%END%\n' +
                    'Dato1,Dato2,Dato3\n' +
                    `${etiqueta},${numero_equipo},{'ubic.': ${ubicacion}// 'eti.': ${etiqueta}// 'serie': ${numero_serie}// 'equipo': ${numero_equipo}// 'mod.': ${modelo}}`
