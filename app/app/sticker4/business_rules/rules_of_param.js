...
module.exports = {
    ...
    save_print: function(req,res, next){
        let ignore_param = ["_id", "__v"];
        let param = ["etiqueta", "numero_serie", "ubicacion", "fecha_alta", "numero_equipo", "ot", "modelo", "quantity"]; // si esta vacio te busca todo los parametros q tenga la "TABLA"
